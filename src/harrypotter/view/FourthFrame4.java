...
public class FourthFrame4 extends JFrame {
	...
	public FourthFrame4() {
		...
		/*proceed.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FourthFrame4 x = new FourthFrame4();
				//FifthFrame y = new FifthFrame();
				x.setVisible(false);
				y.setVisible(true);
